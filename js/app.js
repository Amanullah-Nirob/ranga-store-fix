...
// local object function area start=======================================================================================================
const loadProducts = () => {
...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${image}></img>
      ...
      <h4> <span id="total-rating">Total rating</span> : ${product.rating.count}</h4>
      <h3> Total average rating : ${product.rating.rate}</h3>
      <button onclick="addToCart(${product.id},${product.price})" id="addToCart-btn" class="buy-now btn btn-success">add to cart</button>
      <button id="details-btn" class="btn btn-danger">Details</button></div>
      `;
      // set createElement appendChild in all-products
    document.getElementById("all-products").appendChild(div);
  }
};
// addToCart button has been Applying
let count = 0;
const addToCart = (id, price) => {
  ...
  // updateTotal function has been calling
  updateTotal()
};

// getInputValue button has been Applying
...
// local Object function has been calling
loadProducts();
